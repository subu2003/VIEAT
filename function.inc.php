...
function send_email($email,$html,$subject){
  ...
  $mail->SMTPAuth = true;
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="vieat1234@gmail.com";
  $mail->Password='vieatvieat';
  $mail->setFrom("vieat1234@gmail.com");
...
function forgot($num)
{
  $html='<html><p>Your new Password is <b>'.$num.'</b></p><p>Kindly change your password immediately after Logging In</p><p>Cheers,PENTAGON!</p></html>';
  return $html; 
}
?>